...
# TODO check if this is full cartesian?
...
# TODO how were the death data compiled, this does not seem straightforward?
```
...
tmp <- dm[year == 2018 & gender == 'Female',
         list(pop_female_n = sum(population)),
         by = c('mun','year')]
...
tmp <- dm[year == 2018 & age %in% c("10-14","15-19","20-24","25-29"),
         list(pop_10_29_n = sum(population)),
         by = c('mun','year')]
da <- merge(da, tmp, by = c('mun','year'))
